            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 history-info mt-lg-0 mt-5 pt-md-4 pt-2">
                    <div class="position-relative img-border">
                        <img src="csrc/images/blog4.jpg" class="img-fluid video-popup-image" alt="video-popup">
            ...
            <div class="team-right-content row text-center justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="teams-gd">
                        <div class="team-member">
                            <div class="team-img">
                                <a href="#team"><img class="img-fluid img-responsive" src="csrc/images/team1.jpg"
                                        alt=""></a>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6 mt-sm-0 mt-4">
                    <div class="teams-gd">
                        <div class="team-member">
                            <div class="team-img">
                                <a href="#team"><img class="img-fluid img-responsive" src="csrc/images/team2.jpg"
                                        alt=""></a>
                            </div>
                            <div class="team-hover">
                                <div class="desk">
                ...
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
                    <div class="teams-gd">
                        <div class="team-member">
                            <div class="team-img">
                                <a href="#team"><img class="img-fluid img-responsive" src="csrc/images/team3.jpg"
                                        alt=""></a>
                            </div>
                            <div class="team-hover">
                                <div class="desk">
                ...
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
                    <div class="teams-gd">
                        <div class="team-member">
                            <div class="team-img">
                                <a href="#team"><img class="img-fluid img-responsive" src="csrc/images/team4.jpg"
                                        alt=""></a>
                            </div>
                            <div class="team-hover">
                                <div class="desk">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="customer-single pe-lg-4">
                        ...
                        <div class="customer-img d-flex align-items-center mt-4">
                            <img src="csrc/images/testi1.jpg" class="img-fluid me-3" alt="" />
                ...
                <div class="col-md-4 mt-md-0 mt-5">
                    <div class="customer-single pe-lg-4">
                        ...
                        <div class="customer-img d-flex align-items-center mt-4">
                            <img src="csrc/images/testi2.jpg" class="img-fluid me-3" alt="" />
                            <div class="customer-info">
                                <h6>Jenna John</h6>
                                <small class="mb-0">Subtitle goes here</small>
                            </div>
                ...
                <div class="col-md-4 mt-md-0 mt-5">
                    <div class="customer-single pe-lg-4">
                        ...
                        <div class="customer-img d-flex align-items-center mt-4">
                            <img src="csrc/images/testi3.jpg" class="img-fluid me-3" alt="" />
                            <div class="customer-info">
                                <h6>William Due</h6>
                                <small class="mb-0">Subtitle goes here</small>
                            </div>
