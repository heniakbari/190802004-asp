                ...
                <div class="container">
                    <div class="hero-content">
                        ...
                        <div class="cta-btn" data-animation="fadeInUp" data-delay="1s">
                            <a href="aboutus.aspx" class="btn btn-style btn-primary">View More</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="w3l-servicesblock2 py-5" id="services">
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="grids5-info">
                        <a href="service.aspx" class="blog-image d-block zoom"><img src="csrc/images/s1.jpg" alt=""
                ...
                <div class="col-lg-3 col-sm-6 mt-sm-0 mt-4">
                    <div class="grids5-info">
                        <a href="service.aspx" class="blog-image d-block zoom"><img src="csrc/images/s2.jpg" alt=""
                                class="img-fluid radius-image" />
                            <div class="image-overlay">
                                <h4>Repair</h4>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, consectetur.</p>
                ...
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
                    <div class="grids5-info">
                        <a href="service.aspx" class="blog-image d-block zoom"><img src="csrc/images/s3.jpg" alt=""
                                class="img-fluid radius-image" />
                            <div class="image-overlay">
                                <h4>Сutting-out</h4>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, consectetur.</p>
                ...
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
                    <div class="grids5-info">
                        <a href="service.aspx" class="blog-image d-block zoom"><img src="csrc/images/s4.jpg" alt=""
                                class="img-fluid radius-image" />
                            <div class="image-overlay">
                                <h4>Resize</h4>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, consectetur.</p>
            ...
            <div class="text-center mt-md-5 mt-5 pt-lg-4">
                <a href="service.aspx" class="btn btn-style">View More Services</a>
            </div>
        </div>
    </div>
    <!-- //home services block -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="box-wrap">
                        ...
                        <a href="service.aspx" class="read">Read more</a>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 section-width pe-xl-5">
                    ...
                    <p class="mt-4 pb-dm-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. At, corrupti
                        ...
                        porro repellat officia quas, dolores magnam assumenda soluta odit
                        harum.</p>
                    <a href="aboutus.aspx" class="btn btn-style mt-4"> Know more about us</a>
                </div>
                <div class="col-lg-6 history-info mt-lg-0 mt-5 pt-md-4 pt-2">
                    <div class="position-relative img-border">
                        <img src="csrc/images/about.jpg" class="img-fluid video-popup-image" alt="video-popup">
        ...
        <div class="container py-md-5 py-sm-4 py-2">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-5 text-lg-end">
                    <a href="contact.aspx" class="btn btn-style mt-lg-0 mt-md-5 mt-4">Book your appointment</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row d-grid grid-col-2 grid-element-9 px-lg-0">
                <div class="left-texthny p-lg-5 py-4">
                    <div class="left-texthny-2 p-lg-5 p-4">
                        ...
                        <a href="aboutus.aspx" class="btn btn-style btn-secondary mt-4">Read More</a>
                    </div>
                </div>
            ...
            <div class="row d-grid grid-col-3 grid-element-9 px-lg-0">
                ...
                <div class="left-texthny-3 p-lg-5 py-4 d-grid align-items-center">
                    <div class="sub-wid-grid-9 py-lg-0 py-5">
                        ...
                        <h4 class="text-grid-9"><a href="service.aspx">Our Designs</a></h4>
                ...
                <div class="left-texthny-3 p-lg-5 py-4 d-grid align-items-center">
                    <div class="sub-wid-grid-9 py-lg-0 py-5">
                        ...
                        <h4 class="text-grid-9"><a href="service.aspx">New Styles</a></h4>
                        <p class="sub-para">Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
                    </div>
                </div>
            </div>
    ...
    <div class="w3l-news py-5" id="homeblog">
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="grids5-info">
                        <a href="#blog" class="blog-image d-block zoom"><img src="csrc/images/blog1.jpg"
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="grids5-info">
                        <a href="#blog" class="blog-image d-block zoom"><img src="csrc/images/blog2.jpg"
                                alt="" class="img-fluid news-image" />
                            <div class="image-overlay">
                                <span class="fas fa-plus"></span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                    <div class="grids5-info">
                        <a href="#blog" class="blog-image d-block zoom"><img src="csrc/images/blog3.jpg"
                                alt="" class="img-fluid news-image" />
                            <div class="image-overlay">
                                <span class="fas fa-plus"></span>
                            </div>
